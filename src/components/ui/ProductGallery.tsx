  ...
  return (
    <div className="w-full">
      <div className="flex flex-col gap-4 lg:grid lg:grid-cols-[minmax(0,4fr)_minmax(0,1.2fr)] lg:items-start lg:gap-6">
        <div
          className="h-[360px] w-full overflow-hidden rounded-sm border border-border bg-cover bg-center lg:h-[620px] lg:rounded-3xl lg:border-border lg:shadow-[0_35px_90px_rgba(15,20,24,0.18)]"
          style={{
            ...
            {images.map((image, index) => {
              ...
              return (
                <button
                  ...
                  className={clsx(
                    "h-20 w-20 flex-shrink-0 overflow-hidden rounded-sm border border-border transition-all lg:h-24 lg:w-24 lg:rounded-xl",
